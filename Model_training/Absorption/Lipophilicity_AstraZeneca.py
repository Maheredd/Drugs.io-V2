...
def evaluate_model(model, test_csv, smiles_col="Drug", label_col="Y"):
    ...
    print("\n===== Lipophilicity_AstraZeneca Regression Metrics =====")
...
if __name__ == "__main__":
    category = "Absorption"
    model_name = "Lipophilicity_AstraZeneca"
