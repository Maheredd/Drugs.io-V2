...
def train_model(train_csv: str, smiles_col="Drug", label_col="Y",
    ...
    joblib.dump({"model": model, "feature_cols": feature_cols,
                 "task_type": task_type, "units": units}, save_model_path)
...
def evaluate_model(model, feature_cols, test_csv,
    ...
    if task_type == "classification":
        ...
        print("\n==== Caco2_Wang Classification Metrics ====")
        ...
        try:
            ...
            print("ROC-AUC could not be computed (likely single-class test set)")

    else:
        print("This model is classification only.")

# ---------- Predict and Save (Multiclass Version) ----------
def predict_and_save_multiclass(model, feature_cols, valid_csv, out_csv,
