# CYP2C9_Substrate_CarbonMangels.py (UPDATED WITH FULL TRAIN + TEST METRICS)
...
def egan_rule(mol):
    return (rdMolDescriptors.CalcTPSA(mol) <= 131 and
...
if __name__ == "__main__":
    ...
    category = "Metabolism"
    model_name = "CYP2C9_Substrate_CarbonMangels"
