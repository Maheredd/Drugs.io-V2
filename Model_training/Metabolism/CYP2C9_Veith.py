# CYP2C9_Veith.py (UPDATED WITH FULL TRAIN + TEST METRICS)
...
def veber_rule(mol):
    return (rdMolDescriptors.CalcTPSA(mol) <= 140 and
...
def train_model(train_csv, valid_csv, smiles_col="Drug", label_col="Y",
                ...
                use_fingerprints=True, model_type="xgb"):
...
def evaluate_and_save_predictions(meta, test_csv, prediction_csv=None,
    ...
    X_test, desc_test, idx_test = build_features_and_desc(
        df_test, smiles_col,
