  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="DRUG.IO is an AI-powered platform for drug discovery. Predicts Absorption, Distribution, Metabolism, Excretion, and Toxicity of molecules using machine learning and cheminformatics."
        />

        <meta
          name="keywords"
          content="ADMET, ADMET prediction, ADMET, AI ADMET, machine learning drug discovery, ADMET-X, pharmacokinetics, toxicity prediction, drug metabolism"
        />
      ...
      >
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4 px-4">
          ...
          <h1 className="text-2xl md:text-4xl text-center md:text-left font-bold text-gray-800 dark:text-white">
            Computational Repurposing of FDA-Approved Drugs for Emerging Diseases
